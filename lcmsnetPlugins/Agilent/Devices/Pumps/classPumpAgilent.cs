...
namespace LcmsNet.Devices.Pumps
{
    ...
    [classDeviceControlAttribute(typeof(controlPumpAgilent), 
                                 ...
                                 "Pumps")]
    public class classPumpAgilent : IDevice, IPump
    {
        #region Members
        /// <summary>
        ...
        private void UpdateNotificationStatus(string message, string type)
        {
            ...
            {
                classDeviceStatusEventArgs args = new classDeviceStatusEventArgs(Status, type, this, message);
        ...
        {
            DateTime time = DateTime.UtcNow.Subtract(new TimeSpan(8, 0, 0));
        ...
        {
            DateTime start = DateTime.UtcNow.Subtract(new TimeSpan(8, 0, 0));
            ...
            /// 
            TimeSpan span = DateTime.UtcNow.Subtract(new TimeSpan(8, 0, 0)).Subtract(start);
        ...
        public classMonitoringComponent GetHealthData()
        {
            ...
            component.Name      = Name;
            component.Type      = "Pump";
            component.Model     = "1200 Nano Series";
                                    
            classMonitoringMeasurementScalar measurementOperationMode = new classMonitoringMeasurementScalar();
            measurementOperationMode.Description      = "The total number of minutes of pump data are retained.";
            measurementOperationMode.Name             = "Total Data Minutes";
            measurementOperationMode.Type             = "integer";
            measurementOperationMode.Units            = "";
            measurementOperationMode.Value            = this.TotalMonitoringMinutesDataToKeep.ToString();
            ...
            measurementPumpCount.Description    = "The total number of seconds before each pump data point.";
            measurementPumpCount.Name           = "Total Data Seconds";
            measurementPumpCount.Type           = "integer";
            measurementPumpCount.Units          = "";
            measurementPumpCount.Value          = this.TotalMonitoringSecondElapsed.ToString();
            ...
            classMonitoringMeasurementPlot plotPressure = new classMonitoringMeasurementPlot();
            plotPressure.XUnits = "DateTime";
            plotPressure.YUnits = "bar";
            plotPressure.Name   = "Pressure";
            plotPressure.SetX(mlist_times);
            plotPressure.SetY(mlist_pressures);
            component.PlotData.Add(plotPressure);

            classMonitoringMeasurementPlot percentBPlot = new classMonitoringMeasurementPlot();
            percentBPlot.XUnits = "DateTime";
            percentBPlot.YUnits = "%B";
            percentBPlot.Name   = "Composition";
            percentBPlot.SetX(mlist_times);
            percentBPlot.SetY(mlist_percentB);
            component.PlotData.Add(percentBPlot);

            classMonitoringMeasurementPlot flowratePlot = new classMonitoringMeasurementPlot();
            flowratePlot.XUnits = "DateTime";
            flowratePlot.YUnits = "ul/min";
            flowratePlot.Name   = "Flowrate";
            flowratePlot.SetX(mlist_times);
            flowratePlot.SetY(mlist_flowrates);
            component.PlotData.Add(flowratePlot);
