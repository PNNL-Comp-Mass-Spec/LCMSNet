...
namespace LcmsNet.Devices.Pumps
{
    public static class classIscoConversions
    {
        ...
        #region "Methods"
            ...
            /// <returns>Flow in user units; -1000 on failure</returns></returns>
            ...
            /// <returns>Pressure in user units; -1000 on failure</returns></returns>
            public static double ConvertPressFromString(string inpPress)
            {
                return ConvertPressFromString(inpPress, menu_PressUnits);
            }   
            ...
            /// <param name="units">Units specifier</param>
            /// <returns>Pressure in user units; -1000 on failure</returns></returns>
            public static double ConvertPressFromString(string inpPress, enumIscoPressureUnits units)
            {
                double tmpVal;
                try
                {
            ...
            /// </summary>
            /// <param name="inpLvl">Input string representing level as Liters * 10E9</param>
            ...
            /// </summary>
            /// <param name="units">Units specifier enum</param></param>
            /// <returns>String specifying pressure units; Empty string on error</returns>
