...
namespace LcmsNet.Devices.Pumps
{
    public sealed class classPumpIscoGlyph:FluidicsDevice
    {
        ...
        {
            AddRectangle(new Point(0, 0), new Size(CONST_WIDTH, CONST_HEIGHT), Color.Black, Brushes.White, fill: true);
            AddPort(new Point((int)(CONST_WIDTH * 0.25), -10));
            AddPort(new Point((int)(CONST_WIDTH * 0.5), -10));
            AddPort(new Point((int)(CONST_WIDTH * 0.75), -10));
