...
namespace LcmsNet.Devices.BrukerStart
{
    ...
    [classDeviceControlAttribute(typeof(controlBrukerStart),
                                 typeof(controlBrukerStartGlyph),
                                 "Bruker",
                                 "Detectors")
    ]
...
//          string m_DeviceErrorMessage = "";
        ...
        #region "Constructors"
            public classBrukerStart()
            {
                ...
                mstring_OutputFolderRemote  = Properties.Settings.Default.BrukerOutputFolderShareName;
                mstring_OuputFolderLocal    = Properties.Settings.Default.BrukerOutputFolderLocalName;
                mstring_MethodFolderLocal   = Properties.Settings.Default.BrukerMethodFolderLocalName;
                mstring_BrukerNetName       = Properties.Settings.Default.BrukerInstNetName;
                mint_BrukerPort             = Properties.Settings.Default.BrukerInstPort;
...
//                      classApplicationLogger.LogMessage(0, "Message " + sXcReply.ToString() + " received from Bruker");
            ...
            public List<string> GetMethods()
            {
                ...
                {
                    string methodFolder = Properties.Settings.Default.BrukerMethodFolderShareName;
        ...
        public classMonitoringComponent GetHealthData()
        {
            ...
            measurementAddress.Description       = "The address of the remote server.";
