...
Source: LCMSNetProg\bin\x86\Release\DotNetProjects.Wpf.Extended.Toolkit.dll;           DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\DynamicData.dll;                                   DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\Microsoft.Bcl.*.dll;                               DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\Microsoft.Extensions.*.dll;                        DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\Microsoft.WindowsAPICodePack*.dll;                 DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\Npgsql.dll;                                        DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\OxyPlot*.dll;                                      DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\PRISM.dll;                                         DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\PRISMDatabaseUtils.dll;                            DestDir: "{app}";          Flags: ignoreversion
...
Source: LCMSNetProg\bin\x86\Release\System.Buffers.dll;                                DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Collections.Immutable.dll;                  DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.ComponentModel.Annotations.dll;             DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Diagnostics.DiagnosticSource.dll;           DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Memory.dll;                                 DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Numerics.Vectors.dll;                       DestDir: "{app}";          Flags: ignoreversion
...
Source: LCMSNetProg\bin\x86\Release\System.Text.Encodings.Web.dll;                     DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Text.Json.dll;                              DestDir: "{app}";          Flags: ignoreversion
Source: LCMSNetProg\bin\x86\Release\System.Threading.Channels.dll;                     DestDir: "{app}";          Flags: ignoreversion
...
Source: "LCMSNetProg\PrismDMS.json";                                                   DestDir: "{app}";          Flags: ignoreversion
