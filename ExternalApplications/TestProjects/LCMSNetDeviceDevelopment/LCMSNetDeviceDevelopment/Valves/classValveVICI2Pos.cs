...
namespace LcmsNet.Devices.Valves
{
    ...
    public class classValveVICI2Pos : IDevice
    {
        ...
        protected virtual void OnPosChanged(LcmsNetDataClasses.Devices.enumValvePosition2Pos position)
        {
            if (PosChanged != null)
            {
        ...
        public enumDeviceStatus Status
        {
            get
            {
                return enumDeviceStatus.Disabled;
            }
            set
            {
            }
        ...
        public enumValveErrors SetPosition(enumValvePosition2Pos newPosition)
        {
            ...
            if (newPosition == enumValvePosition2Pos.A)
            {
                ...
                {
                    OnPosChanged((LcmsNetDataClasses.Devices.enumValvePosition2Pos)mobj_lastMeasuredPosition);
                    return enumValveErrors.Success;
                }
            }
