...
namespace LcmsNet.SampleQueue.ViewModels
{
    public class SampleDMSValidatorDisplayViewModel : ReactiveObject
    {
        ...
        {
            samples.Add(new SampleDMSValidationViewModel(new SampleData(false) { DmsData = new DMSData() { DatasetName = "Test DatasetName", RequestID = 1234567,   UsageType = "Cap_Dev", UserList = "(none1)", Experiment = "TestExp1", ProposalID = "5" } }, true, false, false, true, true, true));
            samples.Add(new SampleDMSValidationViewModel(new SampleData(false) { DmsData = new DMSData() { DatasetName = "Test DatasetName", RequestID = 12345678,  UsageType = "Cap_Dev", UserList = "(none2)", Experiment = "TestExp2", ProposalID = "6" } }, false, true, true, false, false, true));
            samples.Add(new SampleDMSValidationViewModel(new SampleData(false) { DmsData = new DMSData() { DatasetName = "Test DatasetName", RequestID = 123456789, UsageType = "Cap_Dev", UserList = "(none3)", Experiment = "TestExp3", ProposalID = "7" } }, true, true, false, true, true, false));
        }
