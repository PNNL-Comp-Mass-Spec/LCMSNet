...
{
    public class FluidicsCircleWpf : GraphicsPrimitiveWpf
    {
        #region Members
        ...
        public FluidicsCircleWpf(Point loc, Color color, Brush fillBrush, int radius = DEFAULT_RADIUS, bool fill = true)
        {
            m_myRadius = radius;
