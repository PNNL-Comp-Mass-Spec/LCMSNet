...
{
    public sealed class FluidicsDetectorWpf : FluidicsDeviceWpf
    {
        private const int WIDTH = 100;
        private const int HEIGHT = 50;
        private readonly Size m_size = new Size(WIDTH, HEIGHT);

        public FluidicsDetectorWpf()
        {
            var myRectangle = new FluidicsRectangleWpf(new Point(0, 0), m_size, Colors.Black, Brushes.White);
