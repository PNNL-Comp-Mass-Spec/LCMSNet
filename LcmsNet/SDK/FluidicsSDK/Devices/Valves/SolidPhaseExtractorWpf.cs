...
{
    public sealed class SolidPhaseExtractorWpf : TwoPositionValveWpf
    {
        private const int NUMBER_OF_PORTS = 6;
        private ISolidPhaseExtractor m_valve;

        public SolidPhaseExtractorWpf()
            : base(NUMBER_OF_PORTS)
        {
            ...
            AddPrimitive(new FluidicsRectangleWpf(new Point(Center.X - 25, Center.Y - 15), new Size(50, 30), Colors.Black, Brushes.White, fill: true, atScale: 1));
        }
        ...
        public override void Render(DrawingContext g, byte alpha, float scale = 1)
        {
            ...
            var volumeText = new FormattedText("SPE", CultureInfo.InvariantCulture, FlowDirection.LeftToRight, font, (11.0F * stringScale) * (96.0 / 72.0), Brushes.Black);
