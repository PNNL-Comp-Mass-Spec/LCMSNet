...
namespace LcmsNetDataClasses.Configuration
{
 	 ...
 	 public class classColumnData : classDataClassBase
    {
        ...
        public delegate void DelegateStatusChanged(object sender, enumColumnStatus previousStatus, enumColumnStatus newStatus);
        /// <summary>
        ...
        public int ID
        {
            get
            {
                return mint_columnIndex;                
            }
            set
            {
                mint_columnIndex = value;                
            }
        }
        /// <summary>
        ...
        public int SystemID
        {
            get
            {
                return mint_systemIndex;
            }
            set
            {
                mint_systemIndex = value;
            }
        }
        /// <summary>
