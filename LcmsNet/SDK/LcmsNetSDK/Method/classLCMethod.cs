...
namespace LcmsNetDataClasses.Method
{
    ...
    public class classLCMethod: classDataClassBase, ICloneable
    {
        ...
        /// </summary>        
        [NonSerialized]
        private DateTime mtime_start;
        /// <summary>
        /// Duration of the method.
        /// </summary>        
        [NonSerialized]
        private TimeSpan mspan_duration;
        /// <summary>
        /// List of LC-events.
        /// </summary>
        [NonSerialized]
        private List<classLCEvent> mlist_events;
        /// <summary>
        /// List of LC-events whose values should reflect the actual start times and durations for an LC-Event.
        /// </summary>
        [NonSerialized]
        private List<classLCEvent> mlist_actualEvents;
        /// <summary>
        ...
        /// </summary>
        public bool HasNonDeterministicStart
        {
            get;
            set;
        }
        ...
        public List<classLCEvent> ActualEvents
        {
            get
            {
                return mlist_actualEvents;
            }
            set
            {
                mlist_actualEvents = value;
            }
        }
        /// <summary>
        ...
        public TimeSpan ActualDuration 
        {
            get
            {
                return ActualEnd.Subtract(ActualStart);
            }
        }
        /// <summary>
