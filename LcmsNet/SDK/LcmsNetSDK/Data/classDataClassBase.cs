						...
						if (tempProp.Name.ToLower() == currentKey.ToLower())
						{
							switch (tempProp.PropertyType.ToString())
							{
								...
								case "System.Drawing.Color":
									Color c = (Color)TypeDescriptor.GetConverter(typeof(Color)).ConvertFromString(currentValue);
									tempProp.SetValue(this, c, null);
									break;
								case "LcmsNetDataClasses.Configuration.enumColumnStatus":
									enumColumnStatus tempEnum = (enumColumnStatus)Enum.Parse(typeof(enumColumnStatus),currentValue);
									tempProp.SetValue(this, tempEnum,null);
									break;
                                case "LcmsNetDataClasses.enumSampleRunningStatus":
                                    enumSampleRunningStatus tempStatus = (enumSampleRunningStatus)Enum.Parse(typeof(enumSampleRunningStatus), currentValue);
								...
								default:
									...
									if (tpName.StartsWith("System.Nullable"))
									{
										...
										{
											throw new Exception("classDataClassBase.LoadPropertyValues(), Invalid property type specified: " +
