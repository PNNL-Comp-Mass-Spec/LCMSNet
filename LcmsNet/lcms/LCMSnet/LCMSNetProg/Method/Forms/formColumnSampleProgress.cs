    ...
    public partial class formColumnSampleProgress : Form
    {
        ...
        private void mtimer_preview_Tick(object sender, EventArgs e)
        {
            ...
            if (PreviewAvailable != null)
            {
                try
                {
                    System.Drawing.Bitmap map = new System.Drawing.Bitmap(mcontrol_sampleProgressFull.Width, mcontrol_sampleProgressFull.Height);
                    System.Drawing.Graphics gfx = System.Drawing.Graphics.FromImage(map);
                    mcontrol_sampleProgressFull.RenderGraph(gfx); //DrawToBitmap(map,new System.Drawing.Rectangle(0, 0, mcontrol_sampleProgressFull.Width, mcontrol_sampleProgressFull.Height));                    
                ...
                {
                    LcmsNetDataClasses.Logging.classApplicationLogger.LogError(0, "Error attempting to update column sample progress.");
                }
            }
        }
