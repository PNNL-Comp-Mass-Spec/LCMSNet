...
public partial class formDMSView : Form
	{
		...
		#region "Properties"
			...
			public string DMSConnStr
			{
				get
				{
					return mstring_DMSConnStr;
				}
				set
				{
					mstring_DMSConnStr = value;
				}
			}	// End property
		#endregion
...
//				classStatusTools.SendStatusMsg("Found " + listviewAvailableRequests.Items.Count.ToString() + " requests in DMS");
				...
				{
					string msg = "You have downloaded samples that have blocking enabled. Please be sure you have downloaded the " +
