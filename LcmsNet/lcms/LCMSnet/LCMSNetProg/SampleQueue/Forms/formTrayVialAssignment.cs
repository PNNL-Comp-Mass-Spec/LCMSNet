...
namespace LcmsNet.SampleQueue.Forms
{
	public partial class formTrayVialAssignment : Form
	{
		...
		#region "Class variables"
			...
			DataTable mobject_DataList = new DataTable("SampleTable");	// Table to hold data for samples in easy-to-handle format
			DataView mobject_DataView = new DataView();	// Controls whether main form will show all samples or unassigned only
			controlTray[] mobject_Trays;	// User control to be added to each tray tab; array is used to simplify later processing
		#endregion
		...
		#region "Properties"
			public List<classSampleData> SampleList { get { return mobject_SampleList; } }
		#endregion
