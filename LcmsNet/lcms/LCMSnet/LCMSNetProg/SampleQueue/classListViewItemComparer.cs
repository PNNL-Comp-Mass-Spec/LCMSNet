	...
	class classListViewItemComparer : IComparer
	{
		...
		#region "Properties"
			...
			public bool sortOrderAsc
			{
				get
				{
					return mbool_SortOrderAsc;
				}
				set
				{
					mbool_SortOrderAsc = value;
				}
			}	 // End property
			...
			public enumListViewComparerMode.SortModeConstants sortMode
			{
				get
				{
					return menum_SortMode;
				}
				set
				{
					menum_SortMode = value;
				}
			}	// End property
		#endregion
		...
		#region "Methods"
			...
			public classListViewItemComparer(int column, bool sortOrderAsc, enumListViewComparerMode.SortModeConstants sortMode)
			{
			...
			/// <param name="sortOrderAsc">Sort order. TRUE for ascending; FALSE for descending</param>
			/// <param name="sortMode">Enum specifying numeric or string data in column</param>
			private void DoConstructorTask(int column, bool sortOrderAsc, enumListViewComparerMode.SortModeConstants sortMode)
			{
				mint_Column = column;
